                                ...
                                <tr>
                                    <td class="content-cell"
                                        ...
                                        <h1
                                            ...
                                            Pemberitahuan Tenggat Keanggotaan!</h1>
                                        <p
                                        ...
                                        <p style="text-align: left">Kepada
                                            <strong>Hakim Asrori</strong> yang terhormat,
                                        </p>
                                        <p style="text-align: left">
                                            Keanggotaan anda di API-IWS Indonesia telah memasuki masa tenggang beberapa
                                            hari lalu.
                                        </p>
                                        <table class="information" width="100%" cellpadding="0" cellspacing="0"
                                            role="presentation"
                                            style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; -premailer-cellpadding: 0; -premailer-cellspacing: 0; -premailer-width: 100%; margin: 0 auto; padding: 0; width: 100%">
                                            <tr>
                                                <td class="content-cell"
                                                        ...
                                                        <tr>
                                                            <td
                                                                ...
                                                                <p
                                                                    ...
                                                                    Untuk memperbarui keanggotaan anda,
                                                                    silakan kunjungi halaman berikut dan ikuti
                                                                    langkah-langkah yang ditunjukkan:
                                                                    <a
                                                                        href="{{ url('payment/history') }}">{{ url('payment/history') }}</a>
                                                                </p>
                                                                <p
                                                                    style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 2rem; text-align: center;">

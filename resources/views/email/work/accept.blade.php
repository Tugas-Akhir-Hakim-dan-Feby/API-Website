                                ...
                                <tr>
                                    <td class="content-cell"
                                        ...
                                        <h1
                                            ...
                                            Penerimaan Lamaran Pekerjaan!</h1>
                                        <p
                                        ...
                                        <p style="text-align: left">Selamat
                                            <strong>{{ $user->name }}</strong>! anda
                                            diterima diperusahaan {{ $jobVacancy->companyMember->company_name }} sebagai
                                            {{ $jobVacancy->welderSkill->skill_name }}.
                                        </p>
                                        <p style="text-align: left">Untuk perihal lainnya akan dibahas di kemudian hari,
                                                    ...
                                                    <table width="100%" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td
                                                                style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative;">
                                                                <p
                                                                    style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 1rem; text-align: left;">
